import { CircleQuestion, Taper } from '@/components/icons';
    ...
    <header className="z-5 fixed top-0 w-full flex flex-col">
      ...
      <div className="px-4 pt-2 max-w-100 mx-auto">
        <Item className="bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 shadow-md">
          <ItemContent>
            <p>
              <span className="font-bold">Taper.</span> Select a line on side A or B to adjust, so
              that the other side unchanged
            </p>
          </ItemContent>
          <ItemActions>
